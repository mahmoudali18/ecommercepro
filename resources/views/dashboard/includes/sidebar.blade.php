...
--}}
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الماركات التجاريه Prands </span>
                    <span
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">المنتجات products  </span>
                    <span
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">خصائص المنتج Attributes  </span>
                    <span
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">  options of product </span>
                    <span
                ...
                <ul class="menu-content">
                    <li class="{{'admin.options' == request()->path() ? 'active' : ''}}"><a class="menu-item" href="{{route('admin.options')}}"
                                                                                               data-i18n="nav.dash.ecommerce"> عرض الكل الخيارات </a>
                    </li>
